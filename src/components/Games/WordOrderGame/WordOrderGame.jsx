...
/**
 * Mezcla determinista semillada por texto. Math.random() en el inicializador
 * de useState produciría un orden distinto en el render de servidor y en el
 * de cliente (error de hidratación) — con la misma semilla, servidor y
 * cliente calculan siempre el mismo "orden aleatorio".
 */
